# -*- coding: utf-8 -*-
"""
Created on Sun Dec  3 19:34:40 2023

@author: annar
"""

from centralizedObjects import Robot, Product, Warehouse
import numpy as np
...
def paperSituation():
    ...
    product5 = Product("P5", 124, [4,6], [4,7])    product6 = Product("P6", 106, [5,5], [5,4])
